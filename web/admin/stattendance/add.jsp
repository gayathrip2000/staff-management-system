    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Add Staff Attendance Record</h2>
          <div class="user-form" style="width: 50%;">
            <form action="StattendanceServlet">
              <div class="form-group">
                <label for="txtMemberId"> Member Id </label>
                <input name="txtMemberId" type="number" class="form-control" id="txtMemberId">
              </div>
              <div class="form-group">
                <label for="txtStdate"> Date </label>
                <input name="txtStdate" type="date" class="form-control" id="txtStdate">
              </div>
              <div class="form-group">
