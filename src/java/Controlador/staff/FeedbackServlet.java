...
@WebServlet(name = "UserFeedbackServlet", urlPatterns = {"/UserFeedbackServlet"})
public class FeedbackServlet extends HttpServlet {
    
    // Get url patterns to variables
    String list="staff/feedback/list.jsp";
    String add="staff/feedback/add.jsp";
    String edit="staff/feedback/edit.jsp";    
