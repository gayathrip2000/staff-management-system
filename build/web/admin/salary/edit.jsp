      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="FeedbackServlet?action=list">Feedbacks</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Edit Salary</h2>
          <div class="user-form" style="width: 50%;">
              <%
              SalaryDAO dao=new SalaryDAO();
              int id=Integer.parseInt((String)request.getAttribute("salaryId"));
              Salary sal=(Salary)dao.list(id);
              %>
            <form>
              
              <div class="form-group">
                <label for="txtMemberCode">Member Code</label>
                <input name="txtMemberCode" type="text" class="form-control" id="txtMemberCode" placeholder="Enter the Member Id" value="<%= sal.getMemberCode()%>" required>
              </div>
                <div class="form-group">
                <label for="txtSalary">Salary</label>
                <input name="txtSalary" type="number" class="form-control" id="txtSalary" placeholder="Enter the Salary" value="<%= sal.getSalary()%>" required>
              </div>
              
                <input type="hidden" name="txtSalaryId" value="<%= sal.getSalaryId()%>">
