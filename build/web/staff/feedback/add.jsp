    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Add Feedback</h2>
          <div class="user-form" style="width: 50%;">
            <form action="UserFeedbackServlet">
              ...
              <div class="form-group">
                <label for="txtMemberName">Feedback</label>
                <textarea name="txtFeedback" type="text" class="form-control" id="txtFeedback" placeholder="Enter Feedback" required></textarea>
              </div>
